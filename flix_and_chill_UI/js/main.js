...
require([
  ...
  'views/alerts',
  'views/notApproved'
], function (Backbone, Workspace, Users, ListView, loggedOutView, NavigationBarView, FlixDb, vm, Alerts, notApproved) {
  /*jshint nonew:false*/
  ...
  Users.on('not_approved', function () {
    vm.showView(notApproved);
  });
});
